...
import main1Image from '../assets/Draw/Main1.png'; 
import main2Image from '../assets/Draw/Main2.png'; 
import main3Image from '../assets/Draw/Main3.png'; 
...
const ResultsContent = styled.div`
  ...
  gap: 10.64px;
  border-radius: 21.29px 0px 0px 0px;
  opacity: 0px;
